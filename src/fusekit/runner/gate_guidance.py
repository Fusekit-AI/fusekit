...
_PROVIDER_GUIDANCE: dict[str, GateGuidance] = {
    ...
    "resend": GateGuidance(
        ...
        actions=(
            ...
            (
                "If the key card says Permission: Full access and Domain: All domains, "
                "the permissions are fine; the missing piece is only the raw key value "
                "copied into FuseKit."
            ),
            (
        ...
        success=(
            ...
            (
                "The first setup key shows Permission: Full access and Domain: All "
                "domains so FuseKit can create the sending domain."
            ),
